...
public class NavigationItemTest {
	...
	{
		NavigationItem item1 = new NavigationItem("Display","Url");
		NavigationItem item2 = new NavigationItem("Display","Url");
	...
	{
		NavigationItem item1 = new NavigationItem("Display","Url");
		NavigationItem item2 = new NavigationItem("x","Url");
	...
	{
		NavigationItem item1 = new NavigationItem("Display","Url");
		NavigationItem item2 = new NavigationItem("Display","x");
		assertThat(item1,not(equalTo(item2)));
		assertThat(item2,not(equalTo(item1)));
	}
	@Test
	...
	{
		NavigationItem item1 = new NavigationItem("Display","Url");
		NavigationItem item2 = new NavigationItem(null,"Url");
		assertThat(item1,not(equalTo(item2)));
		assertThat(item2,not(equalTo(item1)));
	}
	@Test
	...
	{
		NavigationItem item1 = new NavigationItem("Display","Url");
		NavigationItem item2 = new NavigationItem("Display",null);
		assertThat(item1,not(equalTo(item2)));
		assertThat(item2,not(equalTo(item1)));
	}
}
